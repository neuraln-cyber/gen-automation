...
controller_values=(
  ...
  'GEN_AUTOMATION_BACKGROUND_SEMANTIC_MAX_ATTEMPTS=1'
  'GEN_AUTOMATION_BACKGROUND_SEMANTIC_RETRY_BASE_SECONDS=60'
  'GEN_AUTOMATION_BACKGROUND_SEMANTIC_RETRY_MAX_SECONDS=1800'
)
