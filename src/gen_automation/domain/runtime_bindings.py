...
VIDEO_WORKER_ENVIRONMENT_BINDING: Final = "VIDEO_WORKER_ENVIRONMENT"
VIDEO_WORKER_VERIFICATION_KEYS_BINDING: Final = "VIDEO_WORKER_VERIFICATION_KEYS_JSON"
VIDEO_WORKER_ALLOWED_SOURCE_ORIGINS_BINDING: Final = "VIDEO_WORKER_ALLOWED_SOURCE_ORIGINS_JSON"
VIDEO_WORKER_ALLOWED_UPLOAD_ORIGIN_BINDING: Final = "VIDEO_WORKER_ALLOWED_UPLOAD_ORIGIN"
...
SALAD_WORKER_RUNTIME_BINDING_REFERENCES: Final = MappingProxyType(
    {
        ...
        VIDEO_WORKER_ENVIRONMENT_BINDING: ("deployment-config://video-worker/environment"),
        VIDEO_WORKER_VERIFICATION_KEYS_BINDING: (
            "deployment-config://video-worker/verification-keys"
        ),
        VIDEO_WORKER_ALLOWED_SOURCE_ORIGINS_BINDING: (
            "deployment-config://video-worker/allowed-source-origins"
        ),
        VIDEO_WORKER_ALLOWED_UPLOAD_ORIGIN_BINDING: (
            "deployment-config://video-worker/allowed-upload-origin"
        ),
    }
)
...
SALAD_IMAGE_WORKER_ALLOWED_RUNTIME_BINDINGS: Final = frozenset(
    SALAD_WORKER_REQUIRED_RUNTIME_BINDINGS | SALAD_WORKER_OPTIONAL_RUNTIME_BINDINGS
)

SALAD_VIDEO_WORKER_REQUIRED_RUNTIME_BINDINGS: Final = frozenset(
    {
