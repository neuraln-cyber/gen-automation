...
WORKER_RUNTIME_ADMISSION_ID_BINDING: Final = "GEN_WORKER_RUNTIME_ADMISSION_ID"
...
WORKER_ARTIFACT_DELIVERY_DOMAIN_BINDING: Final = "GEN_WORKER_ARTIFACT_DELIVERY_DOMAIN"
...
SALAD_WORKER_RUNTIME_BINDING_REFERENCES: Final = MappingProxyType(
    {
        ...
        WORKER_ARTIFACT_DELIVERY_DOMAIN_BINDING: (
            "deployment-config://salad-worker/artifact-delivery-domain"
        ),
