...
from gen_automation.domain.runtime_bindings import (
    ...
    WORKER_ARTIFACT_DELIVERY_DOMAIN_BINDING,
...
_ARTIFACT_READER_SESSION_DURATION_SECONDS = 43_200
...
_SETTINGS_BINDINGS = {
    ...
    WORKER_ARTIFACT_DELIVERY_DOMAIN_BINDING: "salad_worker_artifact_delivery_domain",
